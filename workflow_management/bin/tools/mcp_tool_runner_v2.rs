...
use mcp_runtime::runtime::mcp_runtime::McpClient;
...
pub struct McpToolRunner {
    ...
    //list_tools:Vec<Tools>,
}

impl McpToolRunner {
    pub fn new(mcp_client: McpClient, tool_name: String) -> Self {
        Self { mcp_client, tool_name }
    }

    pub async fn initialize_mcp_client(mcp_config_path: String) -> anyhow::Result<Option<McpClient>> {
